...
## how it works:
------------------------------------------------------
the main shell configuration (zsh/zshell) is split into 11 seperate configuration files, the main loader is ~/.zshrc , the shell "modules" are stored in ~/zsh.d , and all functions & aliases work together quote-on-quote "neatly".
